-- Final fix: Update ALL references BEFORE converting enum
...
-- Step 4: Update stage_details table
UPDATE stage_details
SET stage_name = 'lc_opening'
WHERE stage_name = 'lc_shared_with_supplier';

-- Step 5: Now drop views with CASCADE
...
-- Step 8: Convert all tables (now they only have valid values)
...
SELECT 'SUCCESS! Refresh browser now.' as result;
