-- This script reverts the database changes to a stable, working state.

-- Step 1: Drop the view and any dependent functions.
DROP VIEW IF EXISTS public.v_shipments_with_all_details CASCADE;

-- Step 2: Recreate the view with the corrected commodity query.
...
-- Step 3: Recreate the original filter function with the corrected commodity comparison.
