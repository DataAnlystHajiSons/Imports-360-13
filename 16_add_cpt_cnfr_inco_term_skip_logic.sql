-- 16_add_cpt_cnfr_inco_term_skip_logic.sql
-- This migration implements CPT, CFR, and CNF skip logic for Freight Query & Award Shipment stages.
-- It:
--   1. Updates stage_requirements_met validation function to auto-pass those stages.
--   2. Updates v_shipments_with_all_details view to count those stages as 1 (completed) under those Inco Terms.
...
-- 2. Recreate stage_requirements_met with CPT, CFR, CNF skip logic
...
SELECT
    ...
    -- Calculate overall progress dynamically adapting to CPT, CFR, and CNF
    (
