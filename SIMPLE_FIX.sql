-- Simple fix: Just update the stage enum and move any shipments
-- No complex migrations, no data loss
...
-- Step 3: Update all tables that use the enum
...
-- Verify
SELECT 'Success! lc_shared_with_supplier removed from enum' as result;
