CREATE OR REPLACE FUNCTION public.handle_freight_query_insert()
RETURNS TRIGGER AS $$
DECLARE
...
DROP TRIGGER IF EXISTS on_freight_query_insert ON public.freight_query;
CREATE TRIGGER on_freight_query_insert
  AFTER INSERT ON public.freight_query
  FOR EACH ROW EXECUTE PROCEDURE public.handle_freight_query_insert();
