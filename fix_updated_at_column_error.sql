-- ============================================================================
-- FIX: Remove updated_at column reference from advance_stage function
-- ============================================================================

-- First, let's check what columns actually exist in the shipment table
SELECT 'Checking shipment table columns:' as info;
...
-- Fix the advance_stage function by removing the updated_at column reference
...
-- Test the function with your specific shipment
SELECT 'Testing advance_stage with your shipment:' as test_section;
...
BEGIN
    ...
    ELSE
        ...
        -- Check IP Number data specifically
