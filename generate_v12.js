...
SELECT
    ...
    (
        -- Calculate overall progress correctly evaluating strict frontend rules defined in STAGE_CONFIG
${fs.readFileSync('D:/Hamza/Imports 360 preserved/sql_cases_fixed.txt', 'utf8').trim()}
...
fs.writeFileSync('D:/Hamza/Imports 360 preserved/update_v_shipments_with_all_details_v12.sql', sqlContent, 'utf8');
