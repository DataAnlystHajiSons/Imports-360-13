-- Final fix: Handle duplicate in stage_details
...
-- Step 4: DELETE the duplicate from stage_details (don't update)
...
SELECT 'SUCCESS! Refresh browser (Ctrl+F5)' as result;
