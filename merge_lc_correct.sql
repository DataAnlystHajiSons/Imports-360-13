-- ============================================
-- Merge LC Stages - Correct Version
...
-- ============================================
-- STEP 4: Update stage_edge table (singular, not plural)
-- ============================================
DO $$
BEGIN
    -- Remove old edges
...
-- ============================================
-- STEP 5: Update audit_log (if any references exist)
-- ============================================
DO $$
DECLARE
    updated_count INTEGER;
...
-- ============================================
-- STEP 6: Update stage_details table (if exists)
-- ============================================
DO $$
BEGIN
...
BEGIN
    ...
    -- Update stage_details table (if exists)
    BEGIN
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE '⚠️ Stage enum update failed: %. This is OK if stage is VARCHAR.', SQLERRM;
END $$;
...
-- Check letter_of_credit structure
SELECT 
...
BEGIN
    ...
    RAISE NOTICE '  3. Verify "LC Management" appears in timeline';
    RAISE NOTICE '  4. Check LC form has all fields';
    RAISE NOTICE '';
    RAISE NOTICE '========================================';
END $$;
