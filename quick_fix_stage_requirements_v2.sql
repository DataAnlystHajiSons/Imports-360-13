-- ============================================================================
-- CORRECTED FIX: stage_requirements_met with proper commodity_id join
-- ============================================================================
-- Fixed: Uses commodity_id foreign key instead of commodity text field
...
BEGIN
  ...
  -- Using commodity_id with proper join to commodity table
  ...
  AND (
    UPPER(c.name) = 'SEED' OR 
    UPPER(c.name) = 'SEEDS' OR
    c.name ILIKE '%seed%'
  )
  LIMIT 1;
