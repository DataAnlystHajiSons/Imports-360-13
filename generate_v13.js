...
let sqlContent = `DROP VIEW IF EXISTS public.v_shipments_with_all_details CASCADE;
...
SELECT
    ...
    (
        ...
        (CASE WHEN EXISTS (SELECT 1 FROM public.bank_endorsement t WHERE t.shipment_id = s.id AND t.endorsed IS NOT NULL) THEN 1 ELSE 0 END) +
...
fs.writeFileSync('D:/Hamza/Imports 360 preserved/update_v_shipments_with_all_details_v13.sql', sqlContent, 'utf8');
